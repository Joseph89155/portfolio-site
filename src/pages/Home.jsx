  ...
  return (
    <div className="dark:bg-gray-900 dark:text-white min-h-screen">
      ...
      <motion.section
        ...
        className="relative flex flex-col items-center justify-center text-center py-24 px-6 bg-white dark:bg-gray-900 text-gray-900 dark:text-white"
      >
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {["Programming", "Data Science", "Data Analysis"].map((title, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gray-100 dark:bg-gray-800 shadow-lg rounded-lg p-6 text-center transition-colors"
            >
              ...
              >
                <Link
                  to="/projects"
                  className="relative overflow-hidden px-6 py-3 bg-blue-600 text-white 
